...
namespace ConsoleApplication
{
    ...
    class ClassFastInvokeHandler2
    {
        ...
        {
            Console.WriteLine("FastInvoke2");

            int times = 1000000;

            Type t = typeof(Person2);
            ...
            {
                person.Say(parameters[0], parameters[1], parameters[2]);
            }
            watch1.Stop();
            ...
            for (int i = 0; i < times; i++)
            {
                methodInfo.Invoke(person, parameters);
            }
            watch2.Stop();
    ...
    {
        public void Say(object word, object p, object avi) { }
